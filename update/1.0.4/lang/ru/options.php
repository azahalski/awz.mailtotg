<?php
$MESS['AWZ_MAILTOTG_OPT_TITLE'] = "AWZ: Письма в Telegram";
$MESS['AWZ_MAILTOTG_OPT_L_BTN_SAVE'] = "Сохранить настройки";
$MESS['AWZ_MAILTOTG_OPT_SECT2'] = "Права доступа";
$MESS['AWZ_MAILTOTG_OPT_SECT1'] = "Общие настройки";
$MESS['AWZ_MAILTOTG_OPT_SHOW_DESC'] = "Отметьте почтовые шаблоны, которые следует пересылать в Telagram";
$MESS['AWZ_MAILTOTG_OPT_SHOW_DESC_1'] = "Код сайта";
$MESS['AWZ_MAILTOTG_OPT_SHOW_DESC_2'] = "Тип шаблона";
$MESS['AWZ_MAILTOTG_OPT_SHOW_DESC_3'] = "Тема письма";
$MESS['AWZ_MAILTOTG_OPT_SHOW_DESC_4'] = "Отправлять в Telegram";
